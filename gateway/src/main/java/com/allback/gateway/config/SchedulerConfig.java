...
public class SchedulerConfig {
    ...
    @Autowired
    private SchedulerService yourService; // 요청 처리를 위한 서비스 클래스를 주입합니다.
    ...
    public Trigger yourTrigger() {
        return TriggerBuilder.newTrigger()
                ...
                .withSchedule(CronScheduleBuilder.cronSchedule("0/5 * * ? * *")) // 5초마다 실행하도록 스케줄링합니다.
                .build();
    }
    ...
    public class YourJob implements org.quartz.Job {
        ...
        public void execute(JobExecutionContext context) {
            // 요청의 상태를 확인하고, 재요청이 없는 경우 후번순인 요청으로 처리하는 로직을 구현합니다.
            yourService.process();
        }
    }
}
